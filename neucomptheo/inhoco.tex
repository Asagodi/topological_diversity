...
1142-1143:
or the sake of understanding the results in this paper, one can think of attractors rather than 6-pseudoattractors since it follows from the definition that the existence of an f-pseudoattractor will imply the existence of an attractor for the noiseless system, and if the noiseless system's attractor is sufficiently robust (as attracting fixed points, in particular, generally are) then there will be a corresponding $\epsilon$-pseudoattractorfor sufficiently low levels of noise.
