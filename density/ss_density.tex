...
\citet{bai2019deq} 				& Infinite	& Yes		& No		 	& Yes 		&				\\\hline
...
TODO
\citep{li1992approximation}


\paragraph{Learning sequences}
 A critical review of recurrent neural networks for sequence learning \citep{lipton2015rnn}
 \citep{pearlmutter1989learning}
...
%
RNNs with activation function is for any point Lipschitz continuous in some neighborhood can be simulated by a family of nonuniform Boolean circuits\citep{siegelmann1994analog}.
%
Finally, RNNs with polynomially bounded weights can simulate any finite automaton (15-neuron upper bound) and any Turing machine (25-neuron network bound) \citep{indyk1995optimal}.
...
Regions of attraction to periodic orbits have an interesting structure: they must be a continuous deformation of a torus: the Cartesian product of an open unit disc of dimension, with a scalar circle coordinate \citep{structure}.
...
%can we really do this sequentially?
%when we change \epsilon_T_i we have to adjust the other \epsilon_T_j s
...
%
The universal approximation propert is equivalent to having a nonpolynomial activation function \citep{pinkus1999approximation}.
