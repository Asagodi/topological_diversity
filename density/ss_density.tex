...
%
RNNs with activation function that is for any point Lipschitz continuous in some neighborhood can be simulated by a family of nonuniform Boolean circuits\citep{siegelmann1994analog}.
%
...
The resulting total approximation is \[\tilde{f}=%\hat{f}+\hat{\hat{f}} = 
 \hat{f} + \epsilon_T(\hat{f} + \hat{\epsilon}\bar{f})\]
...
\citep{conley1978morse, norton1995fundamental}
