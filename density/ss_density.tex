...
\begin{equation}\label{eq:nlc_constraint}
\tilde f_i = (1+ \epsilon_{T_i})\hat{f}_i + \sum_{j}a(\epsilon_{T_j})\hat{\epsilon}_j\bar{f}_j.
\end{equation}
...
\paragraph{Finding local perturbations to simulatneously satisfy Eq.\ref{eq:nlc_constraint} for $i=1,\dots, N$.}
