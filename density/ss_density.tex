...
%
Then, for an arbitrary $\epsilon, \delta > 0$, there exist a FNN $\hat f: \reals^n\rightarrow\reals^n$ with the UAP such that the NODE defined by it $\dot x = \hat f(x)$ %just point to definition in app??
% \begin{equation}
...
\end{equation}
\ascomment{TODO: replace notation with $d_\epsilon$}
