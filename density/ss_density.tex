...
We have a difference in period $T-\hat T = \delta T$
...
TODO: show that if $\delta T$ is small enough then $\epsilon_T$ is small
...
%
Symbolic dynamics: Mapping onto the same discrete dynamical shift dynamical system
