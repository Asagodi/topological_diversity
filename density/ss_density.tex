...
1. Input brings state to separatrix mismatch
    1. Can be controlled by size of mismatch region (and hence autonomous part of the vf (or the asymptotically autonomous vf))
2. Input brings state to wrong side of separatrix
    1. Can be controlled by mismatch in non-autonomous/input-driven factor of vf
...
This equivalence does not hold for input-driven systems (?)
