...
\subsection{Looking beyond the finite-time horizon} %
%Why should we care?
...
Models of neural computation should cover a broader class of dynamics, e.g, oscillations \citep{townley2000existence, kag2020rnns, chang2019antisymmetricrnn}. %could convey preferred capabilities in learning 
...
\subsection{Hyperbolic stable fixed points}
\begin{theorem}
...
\begin{proof}%move to end of section? establish necessary pieces as propositions
