...
By Sec.\ref{sec:separatrix_approx} we can make the part of the state space which will have error bigger than $\epsilon$ arbitrarily small. %for every delta
%for every epsilon
