...
$\{\varphi(t,s) \mid s\in \reals\}$ forms a connected 1D manifold for each $t$
...
1.2: For limit cycles this is a torus-shaped 2D manifold

These manifolds are persistent for each $t$
