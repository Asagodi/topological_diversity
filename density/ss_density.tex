...
%and tje input is not in the kernel of the input function


Important concepts: %?
Input-to-state stability \citep{sontag1995iss, sontag1996iss, sontag2008iss}

Asymptotically autonomous dynamics Supp.Sec.~\ref{sec:asyauto}
-or: forward attractors of non-autonomous dynamical systems \citep{ju2019approximate} \citep{crauel2015nonautonomous} \citep{cheban2002relationship} \citep{cui2018invariant} \citep{kloeden2016construction} \citep{koksch2002pullback}
