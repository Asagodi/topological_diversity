...
Finally, these results fully describe the types of errors between target dynamics and its approximations.
  ...
  Second, what we call trajectory type error, occurs when trajectories diverge but then converge to nearby attractors. %include flowtype_error into figure? 
...
Normally hyperbolic continuous attractors can be approximated as well \citep{Sagodi2024a}.
