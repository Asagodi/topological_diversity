...
Specifically, consider two autonomous dynamical systems defined on the same space:
\begin{align}
    \begin{dcases}
    \dot{\vx} = \vf(\vx)
    \\
...
If more complicated distortions are needed, it is natural to consider their effective behavior less similar.
