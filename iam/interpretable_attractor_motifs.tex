...
%1. Decomposing space into BoAs
In each basin of attraction we have one attractor.
We simplify it's dynamics by looking at its normal form.

%2. Abstracting out transients

%3. A finite set of molds/motifs (abstracting out the space of asymptotic behavior)

%4. Correspondence/Mapping between target and motif: homeomorphism/diffeomorphism
