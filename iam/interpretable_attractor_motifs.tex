...
To make these ideas concrete, we organize attractors in a hierarchy based on their topological dimension.
...
At dimension 0, we include \emph{fixed-point attractors}, which correspond to isolated stable states — common in decision-making or memory models where the system settles into one of several discrete outcomes.
