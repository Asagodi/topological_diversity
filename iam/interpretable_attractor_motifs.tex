...
First, we show that the trajectory distance measure is bounded by perturbation. %First, we show that the trajectory distance measure between a system and its perturbed version is upper bounded by.
...
%2 & Sphere                  & 3D head direction representation \\
\bottomrule
\end{tabular}
\end{table}
