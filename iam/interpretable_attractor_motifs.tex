...
% Interpretable Neural Computation via Canonical Dynamical Motifs
...
Within this framework, we introduce a model reduction method that approximates the essential computational mechanism in a neural system by identifying small perturbations that render two systems diffeomorphic.
...
\item spectral submanifold \citep{cenedese2022data, axaas2023fast, kaszas2024data}
