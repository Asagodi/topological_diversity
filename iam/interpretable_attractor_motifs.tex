...
\begin{figure}[htbp]
    ...
    \caption{Archetypes are compared to each target system in terms of similarity and the simplicity of the deformation needed to match them.
...
\begin{figure}[htbp]
    ...
    \caption{We compare our method to the state-of-the-art methods DSA\citep{ostrow2024beyond} and SPE\citep{friedman2025characterizing}.
        (\textbf{A}) DSA does not detect the approximate ring attractor to ring attractor archetype, nor the oscillator to limit cycle archetype correspondence.
