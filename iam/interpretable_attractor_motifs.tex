...
\graphicspath{{figures/}{figures/all_targets}}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=.5\linewidth]{vdp_vf_trajs}
    \caption{
     }
    \label{fig:vdp_vf_trajs}
\end{figure}

\paragraph{Noisy variant}  
We set $\sigma = 0.75$ for the diffusion coefficient.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=.5\linewidth]{vdpnoisy_vf_trajs}
    \caption{
     }
...
\subsubsection{Deterministic ring attractor}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=.5\linewidth]{ra_vf_trajs}
    \caption{
     }
...
\subsubsection{Noisy ring attractor}
We set $\sigma = 0.25$ for the diffusion coefficient.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=.5\linewidth]{ranoisy_vf_trajs}
    \caption{
     }
