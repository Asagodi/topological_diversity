...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\linewidth]{ds_landscape_carving}
    \caption{Caption}
...
Message: leaving out details for understanding (abstraction), trade-off between interpretability and accuracy
...
\item Bounded square attractor ($[0,1]^2$), Cylinder attractor ($[0,1]\times S_0^1$), Cylinder-LC ($[0,1]\times S_1^1$), Torus attractor ($(S_0^1)^2$), LC-torus attractor ($S_0^1\times S_1^1$), QPTA ($(S_1^1)^2$), Sphere attractor $S^2$
\item ...
\end{enumerate}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=.9\linewidth]{all_motifs_vdp}
    \caption{Caption}
...
In Fig.~\ref{fig:all_motifs_vdp} we used $\mu=0.4$.
