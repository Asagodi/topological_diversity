...
\item We derive novel distance measures that quantify how well an idealized model, i.e. a dynamical motif, explains the original system’s computation and how complicated the correspondence is between them.
