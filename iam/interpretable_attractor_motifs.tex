...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=.99\linewidth]{motif2target}
    ...
    \label{fig:motif2target}
\end{figure}

Normalized similarity for target-motif pairs that are almost topological conjugacally conjugate.
%
