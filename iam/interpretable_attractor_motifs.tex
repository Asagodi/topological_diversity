...
A recently developed method, Dynamical Similarity Analysis (DSA), allows for the quantification of similarity between two systems based on their DMD-approximated linear representations \citep{ostrow2024beyond}.
Assuming the linear system accurately captures the Koopman eigenspectrum, DSA estimates how far the systems are from being conjugate.
However, this approach relies on spectral truncation, which can obscure important nonlinear features such as limit cycles and multistability—key aspects of many neural computations.
...
%
Phase2vec \citep{ricci2022phase2vec} %: learn manifolds of dynamical systems, leading to dynamical embeddings which encode qualitative properties of the underlying systems
...
\subsubsection{The space of models for neural computation}
Mapping families of dynamical systems to a manifold whose geometry encodes different qualitative behaviors \citep{transtrum2014model, ricci2022phase2vec, quinn2022quinn2022information, Vermani2024b}.
