...
2) an RNN trained on a velocity integration task (with a slow ring invariant manifold),
...
The ring attractor-related targets all have high similarity to the \emhp{ring attractor} archetype, while the oscillators have the highest similarity to the \emph{limit cycle} archetype.
