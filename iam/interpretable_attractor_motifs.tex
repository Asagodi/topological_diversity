...
Scientific understanding often advances not by improving predictions, but by changing the vocabulary we use to describe systems.
% Progress in science often comes not from better predictions, but from better descriptions.
