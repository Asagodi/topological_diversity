...
Abstraction is the process of omitting details and finding the essence.
But rather than finding the essence from 
Archetypes are the ideals that are of the most extreme form.
There are no more perfect ring attractor than the ring attractor with the standard ring size.
%the philosophy
