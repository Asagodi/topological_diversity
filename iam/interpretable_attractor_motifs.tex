...
%At the same time, to represent some groups by their most interpretable member.
...
Thus, the smallest perturbation for a given complexity of the diffeomorphism can be described in the following decomposition of the total perturbation as additive in vector field (see Fig.~\ref{fig:pareto}B):
...
%brunton: 
%SINDy: large library of candidate functions \citep{brunton2016discovering, brunton2016sparse, champion2019data, fasel2022ensemble, bakarji2023discovering}
