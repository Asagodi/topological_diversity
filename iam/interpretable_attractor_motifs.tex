...
\item Classification
\item Working memory
\item persistent neural representation (e.g. head direction) % stabilized by recurrent dynamics
\end{itemize}
...
List of tentative deformation operations
translation, permutation, and rotation of the space
uniform scaling of the space
non-uniform scaling of the space
scaling global speed (multiplicative to vector field)
homeomorphism
diffeomorphism
