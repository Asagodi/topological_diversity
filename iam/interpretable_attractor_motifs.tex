...
A further abstraction, now widely adopted, is to focus on their long-term or asymptotic behavior--discretizing the continuous state space into attractors, their basins, and their information content.
...
Yet, this abstraction of the mechanism is often confused to be literal, neglecting that systems with different asymptotic structures can exhibit indistinguishable behavior over task-relevant time scales.
