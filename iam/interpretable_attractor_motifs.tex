...
%reconstruction: 
full dynamics\citep{durstewitz2023reconstructing} \citep{brenner2024almost}
...
%\end{itemize}
 ...
 \paragraph{The space of models for neural computation} %and reducing it
...
For example, \citet{deregt2017understanding} argues that understanding hinges on the intelligibility of theories for human agents, while \citet{potochnik2017idealization} defends the heuristic and epistemic value of idealization, especially in complex biological systems.
...
%time repraram%
 If the correct motif \( g_i \) is selected (in orbit equivalence sense), then there should exist an approximate reparametrization of time \( \tau(t) \) such that \(y(\tau(t)) \approx x(t)\)
