...
If there exists such a homeomorphism, then the two systems are \emph{topologically conjugate} (Def.~\ref{def:top_conj}) and we denote as $\vf(\cdot) \tconju \vg(\cdot)$.
...
Normalized similarity pairs target-motif that are almost topological conjugate and for which a small deformation is possible (Fig.~\ref{fig:archetype2target}).
...
Alternatively, it is also possible that our paramtrization of the homeomorphism is not expressible enough.
