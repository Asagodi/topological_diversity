...
\newpage
\section{The auditory clicks task}
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    \centering
    \includegraphics{figures/centerout_N100_tanh_slow_manifold_3d2d.pdf}
    \caption{\textbf{.}}
    \label{fig:centerout_N100_tanh_slow_manifold_3d2d}
\end{figure}
