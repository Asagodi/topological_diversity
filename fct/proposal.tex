...
In particular for continuous attractor networks, D-type noise is problematic, as it destroys the continuum even the smallest level of noise. %, destroying the ability to represent a continuum of states.
...
%Figure? 
Furthermore, we prove that all hyperbolic continuous attractors are surrounded by dynamical systems that have a slow invariant manifold that is diffeomorphic to the attractor.
