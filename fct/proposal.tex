...
Neural function exhibits robust persistence \citep{gallego2020}, despite the theoretical fragility of proposed models like continuous attractors, which should theoretically cause them to vanish instantly \citep{seung1996, renart2003}.
 This discrepancy between biological neural networks and theoretical models poses a challenge for accurately capturing the dynamics of working memory and other cognitive processes in computational frameworks \citep{calaim2022geometry, renart2003, seeholzer2019, machens2008}.
...
In particular for continuous attractor networks, D-type noise is problematic, as it destroys the continuum even the smallest level of noise (Figure 1). %, destroying the ability to represent a continuum of states.
...
%Figure? 
Furthermore, we prove that all hyperbolic continuous attractors are surrounded by dynamical systems that have a slow invariant manifold that is diffeomorphic to the attractor (Figure 2). %Fig.~\ref{fig:bla_slowmanifolds}.
