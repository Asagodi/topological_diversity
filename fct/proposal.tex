...
Recurrent Neural Networks (RNNs) are popular in computational neuroscience for their ability to model the temporal dynamics and feedback loops present in biological neural systems, enabling researchers to explore hypotheses about neural function and behavior \citep{darshan2022, barak2017recurrent, durstewitz2023reconstructing, yang2019task, yang2019multiple, yang2020artificial, jarne2023b, song2016}.
%challenging for large networks  \citep{lipton2018}. %because of their black-box nature


%why other approaches cant do multi scale
