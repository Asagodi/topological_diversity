...
D-type or``frozen noise'', is caused by continually changing synaptic weights, and is characterized by perturbations to the eqations that describe the dynamics \citep{seeholzer2019, laje2013}.
...
\subsubsection*{Aim 1.2: Analysis of robustness properties of continuous attractors}
 We analyze the following models of ring attractors: \citep{pollock2020, barak2021mapping, beiran2021}.
...
%Decoding, future
Furthermore, as it is important to consider that they may have different computational properties in other contexts, we will determine how the RNN maps these sets onto the outputs.

Output mapping 
the same output is issued by different activity patterns in different movements \citep{athalye2023}


%Interpretability
This provides interpretability, as we can  coarsen the memory states.
