...
A chain recurrent set is a set of points in the neural space such that for any two points in the set, you can find a (noisy) trajectory from one point to the other and back that stays entirely within the set, regardless of how much time it takes.
Slow manifold: network changes very slowly
Asymptotic behavior: network converges to these states
E.g. two rings, one is a recurrent set
Fast: attractive towards recurrent set
slow manifold
%Figure? 
