...
The two possible approximations of a ring attractor have hence very different generalization properties.
The limit cycle approximation will have fading memory, while the possible memory states of the other approximation is determined by the number and placement of stable fixed points.
...
In this section, we delineate a novel approach to dissecting the dynamics of RNNs by segregating time scales to delineate the rapid flow normal to the "ghost" continuous attractor, also known as the slow manifold, and the sluggish flow within.
...
% although \citep{orhan2019diverse} considers many issues concerning how RNNs may hold memory
...
% 
 ...
 Previously, it was observed that  fixed point analysis discussed here has one major limitations, including that the number of fixed points must be the same across networks that are being compared \citep{maheswaranathan2019universality}.
 Our analysis overcomes this limitation.
