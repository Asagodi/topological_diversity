...
Furthermore, the flow of the vector field does not escape\pscomment{is contained in the} the ghost manifold, i.e., it is an invariant manifold.
...
For example, the dynamics of a torus manifold can be described by Kolmogorov-Arnold-Moser (KAM) theory.\pscomment{Technically, only parallel translations, and KAM gives a type of structural stability result.}
