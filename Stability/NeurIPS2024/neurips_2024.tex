...
\subsection{}\label{sec:attractor_bif}
...
\begin{figure}[tbhp]
  \centering
  \includegraphics[width=\textwidth]{angular_losses}
...
\subsubsection{Loss of function: Sensitivity of continuous attractors to perturbations}
