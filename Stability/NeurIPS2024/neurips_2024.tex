...
We trained RNNs on two tasks involving continuous variables: the angular velocity integration task and the memory guided saccade task (details in Sec.Supp.~\ref{sec:supp:tasks}).
