...
where $y$ is the target and $\hat y$ is the prediction.
 ...
 % inv man
  ...
  \begin{figure}[tbhp]
     \centering
    \includegraphics[width=\textwidth]{im_all}
       \caption{The identified invariant manifolds with the fixed points (green for stable, red for saddle and black for unstable).}
         \label{fig:im_all}
\end{figure}
