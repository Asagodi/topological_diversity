...
However, continuous attractors bifurcate almost certainly for an arbitrary perturbation except in special parametric forms.
...
We provide a robust theoretical foundation to better understand the way these structures are robust and hence provide practical utility as models in neuroscience.
...
We characterize this as follows.
---- the supremum over the uniform norm of the vector field tangent to sections in the space of smooth sections of the fiber bundle 
---- supremum over  the uniform norms over the vector field normal to the fibers of the fiber bundle 
...
\paragraph{Example}
\ref{fig:fastslow_decomposition}D
