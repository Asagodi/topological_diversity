...
\begin{figure}[tbhp]
     \centering
  \includegraphics[width=\textwidth]{bio_rings_s}
...
Yet, surprisingly, there is a strong connection in the geometry due to Fenichel's theorem~\cite{fenichel1971}.\footnote{The Persistent Manifold Theorem has been successfully applied previously in neuroscience\citet{Kopell1996,ermentrout2010}, for example to reduce the dimensionality of the Hodgkin-Huxley model\citep{rinzel1985excitation,ermentrout1986parabolic}.}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{sphere_empj_s}
...
\end{equation}with length scale \(\ell\).
 ...
 \begin{figure}[tbhp]
     \centering
    \includegraphics[width=\textwidth]{task_fig_s}
