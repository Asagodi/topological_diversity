...
This supports our theory that theoretical models that satisfy conditions \ref{con	verse:bijection}-\ref{converse:Dtype} and hence have behavior consistent with an almost perfect memory system, will be near continuous attractors (in parameter space).
