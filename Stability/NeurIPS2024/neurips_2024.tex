...
%limitations
We did not explicitly describe the topology and dimensionality of the identified invariant manifolds for all the networks, only for a representative set, yet the results indicate that most solutions have a ring invariant manifold with a slow flow on it.
