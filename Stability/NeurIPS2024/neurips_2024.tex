...
\begin{abstract}
Continuous attractors offer a unique solution to the problem of maintaining a memory of continuous-valued variables for arbitrarily long intervals.
However, the continuous attractors suffer from severe structural instability---infinitesimal changes in the parameters typically destroy the continuous attractor.
