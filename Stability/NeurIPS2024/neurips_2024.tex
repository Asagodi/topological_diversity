...
If these four conditions hold, there exists a smooth function with a uniform norm matching the slowness on the manifold such that when added, it becomes a continuous attractor (Prop.~\ref{prop:revival}, see also Sec.~\ref{sec:near_ca}).
...
The theory guarantees that a system that satisfies condition  will have a continuous attractor in the following sense.
