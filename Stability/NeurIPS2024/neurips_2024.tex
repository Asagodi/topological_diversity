...
<<<<<<< HEAD
\section{A critique of pure continuous attractors}\label{sec:cas}
...
Nevertheless, the bifurcated dynamics again follow a similar patter of the dynamics restricted to the state space around the original continuous attractor.

Firstly, we discuss perturbations of a continuous ring attractor proposed as a model for the head direction representation in fruitflies~\citep{Noorman2022}.
...
Fenichel's Invariant Manifold theorem explains the bifurcation structure of the theoretical models discussed in Sec.~\ref{sec:}.
...
The time discretized version of RNN network activity is
\begin{equation}
  \begin{aligned}
