...
\begin{SCfigure}[10][bthp]
  ...
  \caption{
    ...
    The dashed line is a trajectory ``trapped'' in the slow manifold (which has the same topology as the CA). %change to forward invariant?
    %mention topology?
  }\label{fig:fenichel}
\end{SCfigure}
...
\subsection{Other fixed point fitting methods}
