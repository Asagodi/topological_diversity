...
%resonance gap closing \citep{broer2018persistence}.
...
%- in Theorem 1, what does “locally invariant” actually mean?
%def: locally invariant

%general Fenichel theorem actually says, and how it explains the bifurcation structure
...
\newpage
\section{Near Perfect Analog Memory System must be near a Continuous Attractor}
...
\subsection{Conditions}\label{sec:condition_clarifications}
...
\subsubsection{S-type robustness}\label{sec:stype}


\subsubsection{D-type robustness}\label{sec:persitencempliesnh}
