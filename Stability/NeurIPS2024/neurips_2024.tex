...
To address this issue, we use Fenichel's persistence theorem from dynamical systems theory to show that continuous attractors are robust in the sense that all perturbations maintain the stability and topological structure.
