...
When $d=2$ and $F(I)= \max(0,\cdot)$ is the threshold nonlinearity, we can build a line continuous attractor as follows.
...
The probability of each type of bifurcation was numerically estimated (See Sec.~\ref{sec:supp:}).
...
To understand the underlying mechanism of these bifurcations, it is helpful to consider a well-established way to create a continuum of fixed points on a ring
