...
The normal hyperbolicity is measured by a gap in the eigenvalue spectrum gap of the linearization along points on the invariant manifold (Fig.\ref{fig:eigenvalue_gap}).
