...
We build on the persistent manifold theory to explain the commonalities between bifurcations away from and approximations of continuous attractors.
...
The proposed decomposition is general, and we apply it to theoretical models and task-trained recurrent neural networks (RNNs) to reveal a ``universal motif'' of analog memory mechanism with various potential topologies.
