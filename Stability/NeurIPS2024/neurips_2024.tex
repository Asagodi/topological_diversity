...
\end{figure}
 ...
 We assess the vector field on the found invariant manifold $\manifold$ by calculating it in the state space
 and then projecting it onto the output space:
 \begin{equation}
\wout f(\alpha)
\end{equation}
for sampled points $\alpha\in \manifold$.
 
  
 \begin{figure}[tbhp]
     \centering
    \includegraphics[width=\textwidth]{vf_on_ring_closest_exp0}
       \caption{The projected vector field on the found invariant manifold.}
         \label{fig:vf_on_ring_closest_exp0}
\end{figure}
 
 
 The vector field (Fig. \ref{fig:vf_on_ring_closest_exp0}) suggests that the system
