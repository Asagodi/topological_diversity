...
For a proof, see Sec.~\ref{sec:supp:ub}.
...
Although the corresponding configurations are measure zero in parameter space, we showed that when the persistent manifold theorem holds, the finite time behavior of the trajectories only slowly break down.
...
Unlike in most of dynamical systems theory where the asymptotic behavior and topology of stability structures are studied, we expend equal amount of focus on the effective finite time behavior and the asymptotic behavior.% of the ideal mathematical object.
