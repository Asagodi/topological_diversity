...
We observe that the bifurcations from continuous attractors of theoretical models display various structurally stable dynamical structures with associated generalization characteristics.
Although their asymptotic behavior of memory are categorically distinct, their finite time behavior are similar and degrade gracefully.
