...
%limitations
We did not in detail describe the topology and dimensionality of the identified invariant manifolds.
...
The batches were generated on-line, similar to how animals are trained with a new trial instead of iterating through a dataset of trials.
 ...
 We took the cutoff to identify the slow manifold to be $10^{-3}$.	
