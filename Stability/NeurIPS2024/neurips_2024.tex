...
The computation through dynamics (CTD) framework provides a theoretical lens through which we can understand how complex behaviors, such as animal navigation, emerge from the dynamics of neural systems \citep{vyas2020}.
In the context of animal navigation, the CTD framework suggests that the brain processes sensory information and generates behavioral outputs through neural dynamics.
...
%problem better intro
%intro in 2nd paragraph
...
For continuous attractor networks, even the smallest amount of changes in the synaptic connections are problematic, as it destroys the continuum of fixed points -- this is referred to as the ``fine-tuning problem''  \citep{seung1996, Renart2003}.
