...
\begin{figure}[tbhp]
  ...
  The different solutions are different in their asymptotic dynamics.
  The most often found solution is of the type \emph{fixed point ring manifold} (A and B).
  Less commonly found topologies are slow limit cycles (C) and a slow torus (D).
}
...
% 
% 
Previously, systematically the variability in network dynamics has been surveyed in vanilla RNNs \citep{sussillo2013blackbox, mante2013context, yang2019task, maheswaranathan2019universality,discoll2022}
quantified variations in dynamical solutions over architecture and nonlinearity,
