...
The ring attractor network supports a stable “activity bump” that moves around the ring in correspondence with changes in head direction.
%The position of this bump encodes the head direction.
for the bump attractor network the connection matrix $W$ is a circular Gaussian function of $i-j$.
