...
\begin{prop}[Revival of continuous attractor (informal)]
...
There exist a perturbation with uniform norm at most $\eta$ that induces a bifurcation to a continuous attractor manifold.
\end{prop}
