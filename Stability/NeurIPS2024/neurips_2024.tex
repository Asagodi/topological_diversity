...
Assuming a uniform distribution over the angles, we define the \emph{memory capacity} as the conditional entropy of the continuous memory given the asymptotic state, i.e.\ the stable fixed points (see Sec.~\ref{sec:supp:asymbehav}).
