...
We have shown that continuous attractors are functionally robust and therefore are an important concept to describe the neural computation underlying analog memory.
...
%This reinstates the continuous attractor as the fundamental theoretical concept that represents the collection of approximations.

there's a region in configuration space with systems in it that all have similar behaviors.
