...
The parameters were initialized were initialized from a normal distribution.

For the recurrent weights: $\wrec_{ij}\sim\mathcal{N}(0, \nicefrac{g}{N})$ with a high gain $g=1.5$. 
