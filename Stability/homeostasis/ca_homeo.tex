...
We calculate the gradient w.r.t. a weight change $W_{ij}$:
\begin{equation}
...
\subsection{Outer product learning rule}%Omri Barak's suggesiton
\begin{equation}
...
\[
\frac{\partial}{\partial W_{ij}} \|\dot{x}\|^2 = 2 \dot{x}^T \cdot \phi'(Wx) \cdot x_j
\]
