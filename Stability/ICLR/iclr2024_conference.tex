...
%overcoming vanishing gradients \citep{hochreiter1998vanishing,hu2018overcoming}
...
In practice, the sufficient conditions for RNNs implementing continuous attractors to have this graceful breakdown (like BLA but not UBLA) is for the continuous attractor manifold to be of finite dimension, connected, and bounded. %and normally hyperbolic
