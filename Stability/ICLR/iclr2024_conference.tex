...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{maintenance2.pdf}
  \caption{
...
The invariant manifold of the BLA is persistent throughout learning in many cases, see \ref{sec:supp:learning} and \ref{fig:vfs_T100_F1000_weights}.
...
%scatter
iRNN often finds a different optimum (it settles at a part of the state space that is at a non-zero distance from the initial recurrent matrix and bias (Fig. \ref{fig:maintenance} and Fig \ref{fig:vfs}).
...
\section{Changes to the neural integrator during learning}\label{sec:supp:learning}
...
\begin{figure}[H]
    ...
    \includegraphics[width=\textwidth]{vfs_f100_gs30_optlrs}
       \caption{The dynamics of the recurrent part of the integrators across learning.}
         \label{fig:vfs}
\end{figure}
