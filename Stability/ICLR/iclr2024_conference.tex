...
\begin{figure}[tbhp]
  ...
  \includegraphics[width=\textwidth]{both_rings}
       ...
       (A)       Perturbations to the ring attractor introduced in \cite{Noorman2022}. The ring attractor can be perturbed in systems with an even number of fixed points (stable and saddle points are paired) up to $2N$. 
