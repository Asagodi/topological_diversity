...
\begin{figure}[tbhp]
  ...
  \includegraphics[width=\textwidth]{both_rings}
       ...
       (A)       Perturbations to the ring attractor introduced in \cite{Noorman2022}. The ring attractor can be perturbed in systems with an even number of fixed points (FPs)  up to $2N$ (stable and saddle points are paired). 
