...
This system has as fixed points the origin and the ring with radius one centered around zero, i.e., $(0,0)\cup\{(1,\theta)\ |\ \theta\in[0,2\pi)\}$. We investigate bifurcations caused by parametric perturbations of the ring invariant manifold, which is bounded and boundaryless. All perturbations maintain the invariant manifold (Fig. \ref{fig:both_rings}B).
